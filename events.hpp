...
public:
    ...
    // target: "ALGO" or "BENCH" for specifying which portfolio should fill it
    OrderEvent(string symbol, string order_type, double quantity, string direction, string target = "ALGO");
...
public:
    ...
    FillEvent(long timeindex, string symbol, string exchange, double quantity, string direction,
