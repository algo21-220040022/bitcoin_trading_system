...
public:
    ...
    NaivePortfolio(HistoricalDataHandler* i_bars, vector<string>* i_symbol_list, boost::ptr_vector<Event>* i_events, string* i_start_date, string* i_end_date, double* i_initial_capital);
    ...
    double calculate_quantity(string symbol, double percentage);
